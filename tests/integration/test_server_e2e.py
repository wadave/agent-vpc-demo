...
_PORT = os.getenv("TEST_SERVER_PORT", "8080")
...
def test_chat_stream(server_fixture: subprocess.Popen[str]) -> None:
    ...
    session_url = f"{BASE_URL}/apps/backend/users/{user_id}/sessions"
    ...
    assert has_text_content, "No text content found in stream events"
